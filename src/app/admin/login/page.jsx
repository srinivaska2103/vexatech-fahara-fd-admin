...
export default function AdminLogin() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      const setUser = useAdminAuthStore.getState().setUser;
      setUser(data.user);
    ...
    <div className="min-h-screen flex items-center justify-center bg-fahara-background p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-sm text-fahara-secondary mt-1">Sign in to manage the platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-xs font-semibold text-fahara-text uppercase tracking-wider">Password</label>
              <button 
                type="button"
